  ...
  return (
    <div className="font-sans text-gray-900">
        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="mt-16 grid grid-cols-1 md:grid-cols-3 gap-10">
            {projects.map((project, i) => (
              <div
                key={i}
                className="bg-gray-300 p-8 rounded-3xl shadow hover:shadow-xl transition"
              >
                {/* ✅ Lazy Loaded Image */}
                <LazyImage
                  src={project.img}
      ...
      <section className="py-24 bg-indigo-600 text-white text-center">
        ...
        <Link
          to="/brandstrategy"
          className="mt-8 inline-block px-10 py-4 rounded-2xl bg-white text-indigo-700 font-semibold hover:bg-gray-100 transition"
        >
          View Strategy
        </Link>
      </section>
